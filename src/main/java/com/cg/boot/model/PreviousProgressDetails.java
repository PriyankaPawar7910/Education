...
public class PreviousProgressDetails {
	...
	public PreviousProgressDetails(int gradeId, String grade, String date, int studentId, int adminId) {
		super();
	...
	public PreviousProgressDetails(String grade, String date, int studentId, int adminId) {
		super();
		this.grade = grade;
		this.date = date;
		this.studentId = studentId;
